# Demon Fallen 36 — RECONSTRUCTION v2 2026-09-23 (proposal only, NOT approved, no pitches, no JSON)
Supersedes v1 (demon-name roster). Built from user's 5 cosmology rules after lore-doc loss.
Rules: (1) Fallen angels: former angelic/holy duty, now fallen/corrupted. (2) No shared names with 72 Solomonic demons, not even same-root same-entity. (3) Candidates must be prominent named gods/deities from Jewish/Christian, Norse, Chinese, Indian, Egyptian, Celtic, Japanese, Persian/Babylonian/Mesopotamian, Greek/Roman. (4) God's property should associate with the Order's duty where possible. (5) Higher order generally higher power, with flagged exceptions.
Order duties used: Seraphim burning praise/light; Cherubim wisdom; Thrones judgment; Dominions rulership; Virtues nature/miracles; Powers warfare/protection; Principalities nations/peoples; Archangels messages; Angels individual guardians.
...
## Order 1 Seraphim — burning light/praise (all Months proposed)
...
#6 Odin, Norse, runes/wisdom.matches.wisdom (Month Oct proposed)
#7 Athena, Greek, wisdom.matches.wisdom (Month Nov proposed)
#8 Saraswati, Indian, knowledge/arts.matches.wisdom (Month Dec proposed)

## Order 3 Thrones — judgment (2 Months + 2 Hours proposed)
#9 Anubis, Egyptian, weighing-of-hearts.matches.judgment; triple-note vs Humanoid jackal-folk vs Beast jackals vs Fiend Jackal Husk (Month Feb proposed)
#10 Azazel, J/C, judged/bound.matches.judgment (Month Mar proposed)
#11 Shamash, Mesopotamian, justice.matches.judgment (Hour IX proposed)
#12 Tyr, Norse, oath-justice.matches.judgment (Hour XVIII proposed)
...
## Order 5 Virtues — nature/miracles (all Hours proposed)
#17 Thor, Norse, storms/rain.matches.nature (Hour III proposed)
#18 Susanoo, Japanese, storms.matches.nature (Hour XV proposed)
#19 Indra, Indian, storms.matches.nature (Hour XI proposed)
#20 Set, Egyptian, storms/desert.matches.nature (Hour XXII proposed)
...
## Order 8 Archangels — messages/missions (all Hours proposed)
#29 Hermes, Greek, messenger.matches.messages (Hour I proposed)
#30 Hermod, Norse, Hel-rider messenger.matches.messages (Hour VIII proposed; Hermes-flagged distinct entity)
...
## Tally
Orders 9x4 = 36/36. Pantheons J/C4 Greek6 Egypt5 Japan5 Norse4 Meso3 Chinese2 Indian3 Celtic4 = 36/36. Months 12/12, Hours 24/24, only April locked.
(End of v2 — user corrects names, orders, stations, and power exceptions before Goetic draft and pitches.)
